...
export const metadata: Metadata = {
  title: {
    default: "Capia — Mô phỏng thị trường chứng khoán & AI Mentor",
    template: "%s · Capia",
  },
  description:
  ...
  return (
    <html lang="vi">
      <body>
        ...
        THESIS: Capia is a transaction counter — the app is the branch, and every action is a giao dịch to be filled, stamped, and counted. It refuses the generic light fintech panel and the neon crypto terminal both at once.
